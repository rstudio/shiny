...
${r}`,f=new $n({headline:c,message:p});((Ir(s)?s.get(0):s)||window).dispatchEvent(f)}function t(s,o){let a=n.get(s);a?a.push(o):n.set(s,[o])}function i(s,o){let a=n.get(s);if(a){let r=a.indexOf(o);r>-1&&a.splice(r,1)}a?.length===0&&n.delete(s)}return{addBinding:t,removeBinding:i,checkValidity:e}})();function Tr(n,e){return n===0?"":n===1?`${n} ${e}`:`${n} ${e}s`}function ko(n,e=document.documentElement){let{inputs:t,inputsRate:i,inputBindings:s}=n,o=s.getBindings(),a={};for(let r=0;r<o.length;r++){let l=o[r].binding,u=l.find(e)||[];for(let d=0;d<u.length;d++){let c=u[d];if(c.hasAttribute("data-shiny-no-bind-input"))continue;let p=l.getId(c);if(!p||(0,J.default)(c).hasClass("shiny-bound-input"))continue;let f=l.getType(c),v=f?p+":"+f:p;a[v]={value:l.getValue(c),opts:{immediate:!0,binding:l,el:c}};let $=function(){let I=l,B=c;return function(z){let h;z===!1||z===void 0?h="immediate":z===!0?h="deferred":typeof z=="object"&&"priority"in z?h=z.priority:h=z,Co(t,I,B,h)}}();l.subscribe(c,$),(0,J.default)(c).data("shiny-input-binding",l),(0,J.default)(c).addClass("shiny-bound-input");let C=l.getRatePolicy(c);C!==null&&i.setRatePolicy(v,C.policy,C.delay),zt.addBinding(p,"input"),(0,J.default)(c).trigger({type:"shiny:bound",binding:l,bindingType:"input"})}}return a}async function Ho({sendOutputHiddenState:n,maybeAddThemeObserver:e,outputBindings:t},i=document.documentElement){let s=(0,J.default)(i),o=t.getBindings();for(let a=0;a<o.length;a++){let r=o[a].binding,l=r.find(s)||[];for(let u=0;u<l.length;u++){let d=l[u],c=r.getId(d);if(!c||!J.default.contains(document.documentElement,d))continue;let p=(0,J.default)(d);if(p.hasClass("shiny-bound-output"))continue;e(d);let f=new Hn(d,r);await ls(c,f),p.data("shiny-output-binding",f),p.addClass("shiny-bound-output"),p.attr("aria-live")||p.attr("aria-live","polite"),mt.shinyapp?.$outputProgress.isRecalculating(c)&&f.showProgress(!0),zt.addBinding(c,"output"),p.trigger({type:"shiny:bound",binding:r,bindingType:"output"})}}setTimeout(le.regular,0),setTimeout(n,0)}function Do(n=document.documentElement,e=!1){let t=(0,J.default)(n).find(".shiny-bound-input").toArray();e&&(0,J.default)(n).hasClass("shiny-bound-input")&&t.push(n);for(let i=0;i<t.length;i++){let s=t[i],o=(0,J.default)(s).data("shiny-input-binding");if(!o)continue;let a=o.getId(s);(0,J.default)(s).removeClass("shiny-bound-input"),zt.removeBinding(a,"input"),o.unsubscribe(s),(0,J.default)(s).trigger({type:"shiny:unbound",binding:o,bindingType:"input"})}}function Po({sendOutputHiddenState:n},e=document.documentElement,t=!1){let i=(0,J.default)(e).find(".shiny-bound-output").toArray();t&&(0,J.default)(e).hasClass("shiny-bound-output")&&i.push(e);for(let s=0;s<i.length;s++){let o=(0,J.default)(i[s]),a=o.data("shiny-output-binding");if(!a)continue;let r=a.binding.getId(i[s]);us(r,a),zt.removeBinding(r,"output"),o.removeClass("shiny-bound-output"),o.removeData("shiny-output-binding"),o.trigger({type:"shiny:unbound",binding:a.binding,bindingType:"output"})}setTimeout(le.regular,0),setTimeout(n,0)}async function zi(n,e){await Ho(n,e);let t=ko(n,e);return zt.checkValidity(e),t}function Er(n,e,t=!1){Do(e,t),Po(n,e,t)}async function Sr(n,e){let t=await zi(n,e),i=n.inputs;J.default.each(t,function(s,o){i.setInput(s,o.value,o.opts)}),n.initDeferredIframes()}var Ae=M(S());async function Dn({html:n="",deps:e=[]}={}){await Ne(e),(0,Ae.default)(".modal-backdrop").remove();let t=(0,Ae.default)("#shiny-modal-wrapper");t.length===0&&(t=(0,Ae.default)('<div id="shiny-modal-wrapper"></div>'),(0,Ae.default)(document.body).append(t),t.on("hidden.bs.modal",function(i){i.target===(0,Ae.default)("#shiny-modal")[0]&&(G(t),t.remove())})),t.on("keydown.shinymodal",function(i){(0,Ae.default)("#shiny-modal").data("keyboard")!==!1&&i.keyCode===27&&(i.stopPropagation(),i.preventDefault())}),await ie(t,{html:n})}function Pn(){let n=(0,Ae.default)("#shiny-modal-wrapper");n.off("keydown.shinymodal");let e=n.find(".modal");e.length>0?(e.on("shown.bs.modal",()=>e.modal("hide")),e.modal("hide")):(G(n),n.remove())}var Vt=M(S());var Lo=250;async function Ee({html:n="",action:e="",deps:t=[],duration:i=5e3,id:s=null,closeButton:o=!0,type:a=null}={}){s||(s=Kt()),await Ne(t),_o();let r=Nt(s);r?.length===0&&(r=Ao(s));let l=r,u=`<div class="shiny-notification-content-text">${n}</div><div class="shiny-notification-content-action">${e}</div>`,d=l.find(".shiny-notification-content");await ie(d,{html:u});let c=l?.attr("class");if(c){let f=c.split(/\s+/).filter(v=>v.match(/^shiny-notification-/)).join(" ");l.removeClass(f)}a&&a!=="default"&&l.addClass("shiny-notification-"+a);let p=l.find(".shiny-notification-close");return o&&p.length===0?l.append('<div class="shiny-notification-close">&times;</div>'):!o&&p.length!==0&&p.remove(),i?Ro(s,i):Mr(s),s}function Se(n){Nt(n)?.fadeOut(Lo,function(){G(this),(0,Vt.default)(this).remove(),Bo().length===0&&Ut().remove()})}function Nt(n){return n?Ut().find("#shiny-notification-"+E(n)):null}function Bo(){return Ut().find(".shiny-notification").map(function(){return this.id.replace(/shiny-notification-/,"")}).get()}function Ut(){return(0,Vt.default)("#shiny-notification-panel")}function _o(){let n=Ut();return n.length>0||(0,Vt.default)(document.body).append('<div id="shiny-notification-panel">'),n}function Ao(n){let e=Nt(n);return e?.length===0&&(e=(0,Vt.default)(`<div id="shiny-notification-${n}" class="shiny-notification"><div class="shiny-notification-close">&times;</div><div class="shiny-notification-content"></div></div>`),e.find(".shiny-notification-close").on("click",t=>{t.preventDefault(),t.stopPropagation(),Se(n)}),Ut().append(e)),e}function Ro(n,e){Mr(n);let t=setTimeout(function(){Se(n)},e);Nt(n)?.data("removalCallback",t)}function Mr(n){let t=Nt(n)?.data("removalCallback");t&&clearTimeout(t)}var Vi=M(S());function $r(n){let e=(0,Vi.default)("#shiny-reconnect-time");if(e.length===0)return;let t=Math.floor((n-new Date().getTime())/1e3);t>0?e.text(" in "+t+"s"):e.text("..."),setTimeout(function(){$r(n)},1e3)}async function Ln(n){let e=new Date().getTime()+n;if((0,Vi.default)("#shiny-reconnect-text").length>0)return;await Ee({id:"reconnect",html:'<span id="shiny-reconnect-text">Attempting to reconnect</span><span id="shiny-reconnect-time"></span>',action:'<a id="shiny-reconnect-now" href="#" onclick="Shiny.shinyapp.reconnect();">Try now</a>',duration:null,closeButton:!1,type:"warning"}),$r(e)}function Bn(){Se("reconnect")}var b=M(S());var _n=class{constructor(){this.$promises=[];this.$resolvers=[]}_add(){let e=new Promise(t=>{this.$resolvers.push(t)});this.$promises.push(e)}enqueue(e){this.$resolvers.length||this._add(),this.$resolvers.shift()(e)}async dequeue(){return this.$promises.length||this._add(),this.$promises.shift()}isEmpty(){return!this.$promises.length}isBlocked(){return!!this.$resolvers.length}get length(){return this.$promises.length-this.$resolvers.length}};var Rn,Cr,On,kr,zn,Hr,Jt,Ni,nt,Qt,Me,tt,An=class{constructor(){be(this,Rn);be(this,On);be(this,zn);be(this,Jt);be(this,nt);be(this,Me);this.outputStates=new Map;this.changedOutputs=new Map}takeChanges(){let e=this.changedOutputs;return this.changedOutputs=new Map,e}isRecalculating(e){let t=F(this,nt,Qt).call(this,e);return["initial","running","idle","persistent","invalidated"].includes(t)}updateStateFromMessage(e){Oo(e)&&F(this,Rn,Cr).call(this,e),zo(e)&&F(this,On,kr).call(this,e),Vo(e)&&F(this,zn,Hr).call(this,e)}};Rn=new WeakSet,Cr=function(e){let{name:t,status:i}=e.recalculating,s=F(this,nt,Qt).call(this,t);if(i==="recalculating")switch(s){case"initial":case"invalidated":F(this,Me,tt).call(this,t,"running");break;default:throw new Error(`Shiny server sent a message that the output '${t}' is recalculating,
            ...
            but the output is in an unexpected state of: '${s}'.`)}},On=new WeakSet,kr=function(e){for(let t in e.values)F(this,Jt,Ni).call(this,t,"value");for(let t in e.errors)F(this,Jt,Ni).call(this,t,"error");for(let[t,i]of this.outputStates)switch(i){case"idle":F(this,Me,tt).call(this,t,"cancel");break;case"value":case"error":case"cancel":case"persistent":case"invalidated":break;default:throw new Error(`Shiny server sent a flush message, and after processing the values and errors,
            the output '${t}' has an unexpected ending state of: '${i}'.`)}},zn=new WeakSet,Hr=function(e){let{id:t,persistent:i}=e.progress.message,s=F(this,nt,Qt).call(this,t);if(i)switch(s){case"running":F(this,Me,tt).call(this,t,"persistent");break;default:throw new Error(`Shiny server has sent a 'persistent progress' message for ${t},
