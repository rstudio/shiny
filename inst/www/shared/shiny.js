...
(function () {
  ...
  function pickBy(obj, predicate) {
    var newObj = {};
    for (var key in obj) {
      if (obj.hasOwnProperty(key) && predicate(obj[key], key)) newObj[key] = obj[key];
    }
    return newObj;
  }
  ...
  // arguments: (value, key, object). Like the mapKeys function from lodash.
  function mapKeys(obj, f) {
    var newObj = {};
    for (var key in obj) {
      if (obj.hasOwnProperty(key)) newObj[f(key)] = obj[key];
    }
    return newObj;
  }
