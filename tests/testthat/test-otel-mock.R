...
test_server_with_otel <- function(session, server, expr, args = list()) {
...
test_that("reactiveVal / reactiveValues is supported", {
  server <- function(input, output, session) {
    rv <- reactiveVal(0)
...
test_that("reactive is supported", {
  server <- function(input, output, session) {
    r <- reactive({ 42 })
...
test_that("outputs are supported", {
  server <- function(input, output, session) {
...
test_that("extended tasks are supported", {
  server <- function(input, output, session) {
