...
testServer("../..", expr = {
  ...
  expect_equal(nrow(dplyr::filter(df(), selected_)), 22)
  expect_equal(output$summary, "22 observation(s) selected")
  plotVal22 <- output$`scatters-plot1`
})
