...
`,Mn=class Mn extends Te{toggleCollapsed(){this.classList.toggle("collapsed"),this.querySelector(".toggle-button")?.blur()}handleDismissAll(){this.classList.add("leaving"),this.addEventListener("animationend",()=>{this.remove()})}static createClientMessageElement({headline:e,message:t}){let i=document.createElement("shiny-error-message");return i.setAttribute("headline",e||""),i.setAttribute("message",t),i}appendConsoleMessage({headline:e,message:t}){let i=this.shadowRoot?.querySelector("slot.content");if(i){let s=a=>{let r=a.getAttribute("headline")||"",l=a.getAttribute("message")||"";return`${r}::${l}`},o=`${e}::${t}`;for(let a of i.assignedElements())if(a.tagName.toLowerCase()==="shiny-error-message"&&s(a)===o)return}this.appendChild(Mn.createClientMessageElement({headline:e,message:t}))}render(){return Bi` <div class="header">
...
${r}`,m=new Sn({headline:c,message:p});((Ir(s)?s.get(0):s)||window).dispatchEvent(m)}function t(s,o){let a=n.get(s);a?a.push(o):n.set(s,[o])}function i(s,o){let a=n.get(s);if(a){let r=a.indexOf(o);r>-1&&a.splice(r,1)}a?.length===0&&n.delete(s)}return{addBinding:t,removeBinding:i,checkValidity:e}})();function Tr(n,e){return n===0?"":n===1?`${n} ${e}`:`${n} ${e}s`}function Do(n,e=document.documentElement){let{inputs:t,inputsRate:i,inputBindings:s}=n,o=s.getBindings(),a={};for(let r=0;r<o.length;r++){let l=o[r].binding,u=l.find(e)||[];for(let d=0;d<u.length;d++){let c=u[d];if(c.hasAttribute("data-shiny-no-bind-input"))continue;let p=l.getId(c);if(!p||(0,Q.default)(c).hasClass("shiny-bound-input"))continue;let m=l.getType(c),y=m?p+":"+m:p;a[y]={value:l.getValue(c),opts:{immediate:!0,binding:l,el:c}};let $=function(){let I=l,L=c;return function(K){ko(t,I,L,K)}}();l.subscribe(c,$),(0,Q.default)(c).data("shiny-input-binding",l),(0,Q.default)(c).addClass("shiny-bound-input");let C=l.getRatePolicy(c);C!==null&&i.setRatePolicy(y,C.policy,C.delay),Rt.addBinding(p,"input"),(0,Q.default)(c).trigger({type:"shiny:bound",binding:l,bindingType:"input"})}}return a}async function Po({sendOutputHiddenState:n,maybeAddThemeObserver:e,outputBindings:t,outputIsRecalculating:i},s=document.documentElement){let o=(0,Q.default)(s),a=t.getBindings();for(let r=0;r<a.length;r++){let l=a[r].binding,u=l.find(o)||[];for(let d=0;d<u.length;d++){let c=u[d],p=l.getId(c);if(!p||!Q.default.contains(document.documentElement,c))continue;let m=(0,Q.default)(c);if(m.hasClass("shiny-bound-output"))continue;e(c);let y=new kn(c,l);await ls(p,y),m.data("shiny-output-binding",y),m.addClass("shiny-bound-output"),m.attr("aria-live")||m.attr("aria-live","polite"),i(p)&&y.showProgress(!0),Rt.addBinding(p,"output"),m.trigger({type:"shiny:bound",binding:l,bindingType:"output"})}}setTimeout(ue.regular,0),setTimeout(n,0)}function Bo(n=document.documentElement,e=!1){let t=(0,Q.default)(n).find(".shiny-bound-input").toArray();e&&(0,Q.default)(n).hasClass("shiny-bound-input")&&t.push(n);for(let i=0;i<t.length;i++){let s=t[i],o=(0,Q.default)(s).data("shiny-input-binding");if(!o)continue;let a=o.getId(s);(0,Q.default)(s).removeClass("shiny-bound-input"),Rt.removeBinding(a,"input"),o.unsubscribe(s),(0,Q.default)(s).trigger({type:"shiny:unbound",binding:o,bindingType:"input"})}}function Lo({sendOutputHiddenState:n},e=document.documentElement,t=!1){let i=(0,Q.default)(e).find(".shiny-bound-output").toArray();t&&(0,Q.default)(e).hasClass("shiny-bound-output")&&i.push(e);for(let s=0;s<i.length;s++){let o=(0,Q.default)(i[s]),a=o.data("shiny-output-binding");if(!a)continue;let r=a.binding.getId(i[s]);us(r,a),Rt.removeBinding(r,"output"),o.removeClass("shiny-bound-output"),o.removeData("shiny-output-binding"),o.trigger({type:"shiny:unbound",binding:a.binding,bindingType:"output"})}setTimeout(ue.regular,0),setTimeout(n,0)}async function Oi(n,e){await Po(n,e);let t=Do(n,e);return Rt.checkValidity(e),t}function Er(n,e,t=!1){Bo(e,t),Lo(n,e,t)}async function Sr(n,e){let t=await Oi(n,e),i=n.inputs;Q.default.each(t,function(s,o){i.setInput(s,o.value,o.opts)}),n.initDeferredIframes()}var _e=M(S());async function Hn({html:n="",deps:e=[]}={}){await Ve(e),(0,_e.default)(".modal-backdrop").remove();let t=(0,_e.default)("#shiny-modal-wrapper");t.length===0&&(t=(0,_e.default)('<div id="shiny-modal-wrapper"></div>'),(0,_e.default)(document.body).append(t),t.on("hidden.bs.modal",function(i){i.target===(0,_e.default)("#shiny-modal")[0]&&(G(t),t.remove())})),t.on("keydown.shinymodal",function(i){(0,_e.default)("#shiny-modal").data("keyboard")!==!1&&i.keyCode===27&&(i.stopPropagation(),i.preventDefault())}),await re(t,{html:n})}function Dn(){let n=(0,_e.default)("#shiny-modal-wrapper");n.off("keydown.shinymodal");let e=n.find(".modal");e.length>0?(e.on("shown.bs.modal",()=>e.modal("hide")),e.modal("hide")):(G(n),n.remove())}var At=M(S());var _o=250;async function Ee({html:n="",action:e="",deps:t=[],duration:i=5e3,id:s=null,closeButton:o=!0,type:a=null}={}){s||(s=Xt()),await Ve(t),Ao();let r=Ot(s);r?.length===0&&(r=Oo(s));let l=r,u=`<div class="shiny-notification-content-text">${n}</div><div class="shiny-notification-content-action">${e}</div>`,d=l.find(".shiny-notification-content");await re(d,{html:u});let c=l?.attr("class");if(c){let m=c.split(/\s+/).filter(y=>y.match(/^shiny-notification-/)).join(" ");l.removeClass(m)}a&&a!=="default"&&l.addClass("shiny-notification-"+a);let p=l.find(".shiny-notification-close");return o&&p.length===0?l.append('<div class="shiny-notification-close">&times;</div>'):!o&&p.length!==0&&p.remove(),i?zo(s,i):Mr(s),s}function Se(n){Ot(n)?.fadeOut(_o,function(){G(this),(0,At.default)(this).remove(),Ro().length===0&&zt().remove()})}function Ot(n){return n?zt().find("#shiny-notification-"+E(n)):null}function Ro(){return zt().find(".shiny-notification").map(function(){return this.id.replace(/shiny-notification-/,"")}).get()}function zt(){return(0,At.default)("#shiny-notification-panel")}function Ao(){let n=zt();return n.length>0||(0,At.default)(document.body).append('<div id="shiny-notification-panel">'),n}function Oo(n){let e=Ot(n);return e?.length===0&&(e=(0,At.default)(`<div id="shiny-notification-${n}" class="shiny-notification"><div class="shiny-notification-close">&times;</div><div class="shiny-notification-content"></div></div>`),e.find(".shiny-notification-close").on("click",t=>{t.preventDefault(),t.stopPropagation(),Se(n)}),zt().append(e)),e}function zo(n,e){Mr(n);let t=setTimeout(function(){Se(n)},e);Ot(n)?.data("removalCallback",t)}function Mr(n){let t=Ot(n)?.data("removalCallback");t&&clearTimeout(t)}var zi=M(S());function $r(n){let e=(0,zi.default)("#shiny-reconnect-time");if(e.length===0)return;let t=Math.floor((n-new Date().getTime())/1e3);t>0?e.text(" in "+t+"s"):e.text("..."),setTimeout(function(){$r(n)},1e3)}async function Pn(n){let e=new Date().getTime()+n;if((0,zi.default)("#shiny-reconnect-text").length>0)return;await Ee({id:"reconnect",html:'<span id="shiny-reconnect-text">Attempting to reconnect</span><span id="shiny-reconnect-time"></span>',action:'<a id="shiny-reconnect-now" href="#" onclick="Shiny.shinyapp.reconnect();">Try now</a>',duration:null,closeButton:!1,type:"warning"}),$r(e)}function Bn(){Se("reconnect")}var v=M(S());var Ln=class{constructor(){this.$promises=[];this.$resolvers=[]}_add(){let e=new Promise(t=>{this.$resolvers.push(t)});this.$promises.push(e)}enqueue(e){this.$resolvers.length||this._add(),this.$resolvers.shift()(e)}async dequeue(){return this.$promises.length||this._add(),this.$promises.shift()}isEmpty(){return!this.$promises.length}isBlocked(){return!!this.$resolvers.length}get length(){return this.$promises.length-this.$resolvers.length}};var R,Cr,kr,Hr,Vi,Vt,Ye,_n=class{constructor(){Qt(this,R);this.outputStates=new Map;this.changedOutputs=new Map}takeChanges(){let e=this.changedOutputs;return this.changedOutputs=new Map,e}isRecalculating(e){let t=F(this,R,Vt).call(this,e);return["initial","running","idle","persistent","invalidated"].includes(t)}updateStateFromMessage(e){Vo(e)&&F(this,R,Cr).call(this,e),No(e)&&F(this,R,kr).call(this,e),Uo(e)&&F(this,R,Hr).call(this,e)}};R=new WeakSet,Cr=function(e){let{name:t,status:i}=e.recalculating,s=F(this,R,Vt).call(this,t);if(i==="recalculating")switch(s){case"initial":case"invalidated":F(this,R,Ye).call(this,t,"running");break;default:throw new Error(`Shiny server sent a message that the output '${t}' is recalculating,
            but the output is in an unexpected state of: '${s}'.`)}if(i==="recalculated")switch(s){case"running":F(this,R,Ye).call(this,t,"idle");break;default:throw new Error(`Shiny server sent a message that the output '${t}' has been recalculated,
            but the output is in an unexpected state of: '${s}'.`)}},kr=function(e){for(let t in e.values)F(this,R,Vi).call(this,t,"value");for(let t in e.errors)F(this,R,Vi).call(this,t,"error");for(let[t,i]of this.outputStates)switch(i){case"idle":F(this,R,Ye).call(this,t,"cancel");break;case"value":case"error":case"cancel":case"persistent":case"invalidated":break;default:throw new Error(`Shiny server sent a flush message, and after processing the values and errors,
            the output '${t}' has an unexpected ending state of: '${i}'.`)}},Hr=function(e){let{id:t,persistent:i}=e.progress.message,s=F(this,R,Vt).call(this,t);if(i)switch(s){case"running":F(this,R,Ye).call(this,t,"persistent");break;default:throw new Error(`Shiny server has sent a 'persistent progress' message for ${t},
            but the output is in an unexpected state of: ${s}`)}else switch(s){case"value":case"error":case"cancel":case"persistent":case"idle":F(this,R,Ye).call(this,t,"invalidated");break;default:throw new Error(`Shiny server has sent a progress message for ${t},
            but the output is in an unexpected state of: ${s}`)}},Vi=function(e,t){let i=F(this,R,Vt).call(this,e);switch(i){case"idle":F(this,R,Ye).call(this,e,t);break;default:throw new Error(`Shiny server has sent a ${t} for the output '${e}',
          but the output is in an unexpected state of: '${i}'.`)}},Vt=function(e){return this.outputStates.get(e)??"initial"},Ye=function(e,t){let i=this.isRecalculating(e);this.outputStates.set(e,t);let s=this.isRecalculating(e);i!==s&&this.changedOutputs.set(e,s)};function Vo(n){return n.recalculating!==void 0}function No(n){let e=n;return e.values!==void 0&&e.errors!==void 0}function Uo(n){let e=n;return e.progress!==void 0&&e.progress.type==="binding"}var Dr=[],Ni={},Rn=[],An={};function A(n,e){if(Ni[n])throw'handler for message of type "'+n+'" already added.';if(typeof e!="function")throw"handler must be a function.";if(e.length!==1)throw"handler must be a function that takes one argument.";Dr.push(n),Ni[n]=e}function Pr(n,e){if(An[n]){let t=Rn.indexOf(n);t!==-1&&(Rn.splice(t,1),delete An[n])}if(typeof e!="function")throw"handler must be a function.";if(e.length!==1)throw"handler must be a function that takes one argument.";Rn.push(n),An[n]=e}var On=class{constructor(){this.$socket=null;this.taskQueue=new Ln;this.config=null;this.$inputValues={};this.$initialInput=null;this.$bindings={};this.$outputProgress=new _n;this.$values={};this.$errors={};this.$conditionals={};this.$pendingMessages=[];this.$activeRequests={};this.$nextRequestId=0;this.$allowReconnect=!1;this.scheduledReconnect=void 0;this.reconnectDelay=function(){let e=0,t=[1500,1500,2500,2500,5500,5500,10500];return{next:function(){let i=e;return i>=t.length&&(i=t.length-1),e++,t[i]},reset:function(){e=0}}}();this.progressHandlers={binding:function(e){let t=e.id,i=this.$bindings[t];i&&(0,v.default)(i.el).trigger({type:"shiny:outputinvalidated",binding:i,name:t}),this._updateProgress()},open:async function(e){if(e.style==="notification")await Ee({html:`<div id="shiny-progress-${e.id}" class="shiny-progress-notification"><div class="progress active" style="display: none;"><div class="progress-bar"></div></div><div class="progress-text"><span class="progress-message">message</span> <span class="progress-detail"></span></div></div>`,id:e.id,duration:null});else if(e.style==="old"){let t=(0,v.default)(".shiny-progress-container");t.length===0&&(t=(0,v.default)('<div class="shiny-progress-container"></div>'),(0,v.default)(document.body).append(t));let i=(0,v.default)(".shiny-progress.open").length,s=(0,v.default)('<div class="shiny-progress open"><div class="progress active"><div class="progress-bar bar"></div></div><div class="progress-text"><span class="progress-message">message</span><span class="progress-detail"></span></div></div>');s.attr("id",e.id),t.append(s);let o=s.find(".progress");if(o){o.css("top",i*o.height()+"px");let a=s.find(".progress-text");a.css("top",3*o.height()+i*a.outerHeight()+"px"),s.hide()}}},update:function(e){if(e.style==="notification"){let t=(0,v.default)("#shiny-progress-"+e.id);if(t.length===0)return;typeof e.message<"u"&&t.find(".progress-message").text(e.message),typeof e.detail<"u"&&t.find(".progress-detail").text(e.detail),typeof e.value<"u"&&e.value!==null&&(t.find(".progress").show(),t.find(".progress-bar").width(e.value*100+"%"))}else if(e.style==="old"){let t=(0,v.default)("#"+e.id+".shiny-progress");typeof e.message<"u"&&t.find(".progress-message").text(e.message),typeof e.detail<"u"&&t.find(".progress-detail").text(e.detail),typeof e.value<"u"&&e.value!==null&&(t.find(".progress").show(),t.find(".bar").width(e.value*100+"%")),t.fadeIn()}},close:function(e){if(e.style==="notification")Se(e.id);else if(e.style==="old"){let t=(0,v.default)("#"+e.id+".shiny-progress");t.removeClass("open"),t.fadeOut({complete:function(){t.remove(),(0,v.default)(".shiny-progress").length===0&&(0,v.default)(".shiny-progress-container").remove()}})}}};this._init()}connect(e){if(this.$socket)throw"Connect was already called on this application object";this.$socket=this.createSocket(),this.$initialInput=e,v.default.extend(this.$inputValues,e),this.$updateConditionals()}isConnected(){return!!this.$socket}reconnect(){if(clearTimeout(this.scheduledReconnect),this.isConnected())throw"Attempted to reconnect, but already connected.";this.$socket=this.createSocket(),this.$initialInput=v.default.extend({},this.$inputValues),this.$updateConditionals()}createSocket(){let t=(fs()||(()=>{let s="ws:";window.location.protocol==="https:"&&(s="wss:");let o=window.location.pathname;/^([$#!&-;=?-[\]_a-z~]|%[0-9a-fA-F]{2})+$/.test(o)||(o=encodeURI(o),Ki()&&(o=encodeURI(o))),/\/$/.test(o)||(o+="/"),o+="websocket/";let a=new WebSocket(s+"//"+window.location.host+o);return a.binaryType="arraybuffer",a}))(),i=!1;return t.onopen=()=>{for(i=!0,(0,v.default)(document).trigger({type:"shiny:connected",socket:t}),this.onConnected(),t.send(JSON.stringify({method:"init",data:this.$initialInput}));this.$pendingMessages.length;){let s=this.$pendingMessages.shift();t.send(s)}this.startActionQueueLoop()},t.onmessage=s=>{this.taskQueue.enqueue(async()=>await this.dispatchMessage(s.data))},t.onclose=s=>{let o=s.code===1012;i&&((0,v.default)(document).trigger({type:"shiny:disconnected",socket:t}),this.$notifyDisconnected()),this.onDisconnected(o),this.$removeSocket()},t}async startActionQueueLoop(){for(;;)try{await(await this.taskQueue.dequeue())()}catch(e){$n(e),console.error(e)}}sendInput(e){let t=JSON.stringify({method:"update",data:e});this.$sendMsg(t),v.default.extend(this.$inputValues,e),this.$updateConditionals()}$notifyDisconnected(){window.parent&&window.parent.postMessage("disconnected","*")}$removeSocket(){this.$socket=null}$scheduleReconnect(e){this.scheduledReconnect=window.setTimeout(()=>{this.reconnect()},e)}onDisconnected(e=!1){if((0,v.default)("#shiny-disconnected-overlay").length===0&&(0,v.default)(document.body).append('<div id="shiny-disconnected-overlay"></div>'),(0,v.default)("#shiny-disconnected-overlay").toggleClass("reloading",e),this.$allowReconnect===!0&&this.$socket.allowReconnect===!0||this.$allowReconnect==="force"){let t=this.reconnectDelay.next();Pn(t),this.$scheduleReconnect(t)}}onConnected(){(0,v.default)("#shiny-disconnected-overlay").remove(),Bn(),this.reconnectDelay.reset()}makeRequest(e,t,i,s,o){let a=this.$nextRequestId;for(;this.$activeRequests[a];)a=(a+1)%1e9;this.$nextRequestId=a+1,this.$activeRequests[a]={onSuccess:i,onError:s};let r=JSON.stringify({method:e,args:t,tag:a});if(o){let l=function(p){let m=new ArrayBuffer(4);return new DataView(m).setUint32(0,p,!0),m},u=[];u.push(l(16908802));let d=new Blob([r]);u.push(l(d.size)),u.push(d);for(let p=0;p<o.length;p++){let m=o[p];u.push(l(m.byteLength||m.size||0)),u.push(m)}r=new Blob(u)}this.$sendMsg(r)}$sendMsg(e){this.$socket&&this.$socket.readyState?this.$socket.send(e):this.$pendingMessages.push(e)}receiveError(e,t){if(this.$errors[e]===t)return;this.$errors[e]=t,delete this.$values[e];let i=this.$bindings[e],s=v.default.Event("shiny:error");s.name=e,s.error=t,s.binding=i,(0,v.default)(i?i.el:document).trigger(s),!s.isDefaultPrevented()&&i&&i.onValueError&&i.onValueError(s.error)}async receiveOutput(e,t){let i=this.$bindings[e],s=v.default.Event("shiny:value");if(s.name=e,s.value=t,s.binding=i,this.$values[e]===t){(0,v.default)(i?i.el:document).trigger(s);return}return this.$values[e]=t,delete this.$errors[e],(0,v.default)(i?i.el:document).trigger(s),!s.isDefaultPrevented()&&i&&await i.onValueChange(s.value),t}async bindOutput(e,t){if(!e)throw new Error("Can't bind an element with no ID");return this.$bindings[e]=t,this.$values[e]!==void 0?await t.onValueChange(this.$values[e]):this.$errors[e]!==void 0&&t.onValueError(this.$errors[e]),t}unbindOutput(e,t){return this.$bindings[e]===t?(delete this.$bindings[e],!0):!1}_narrowScopeComponent(e,t){return Object.keys(e).filter(i=>i.indexOf(t)===0).map(i=>({[i.substring(t.length)]:e[i]})).reduce((i,s)=>v.default.extend(i,s),{})}_narrowScope(e,t){return t?{input:this._narrowScopeComponent(e.input,t),output:this._narrowScopeComponent(e.output,t)}:e}$updateConditionals(){(0,v.default)(document).trigger({type:"shiny:conditional"});let e={};for(let s in this.$inputValues)if(se(this.$inputValues,s)){let o=s.replace(/:.*/,"");e[o]=this.$inputValues[s]}let t={input:e,output:this.$values},i=(0,v.default)(document).find("[data-display-if]");for(let s=0;s<i.length;s++){let o=(0,v.default)(i[s]),a=o.data("data-display-if-func");if(!a){let c=o.attr("data-display-if");a=$s(c),o.data("data-display-if-func",a)}let r=o.attr("data-ns-prefix"),l=this._narrowScope(t,r),u=!!a(l),d=o.css("display")!=="none";u!==d&&(u?(o.trigger("show"),o.show(),o.trigger("shown")):(o.trigger("hide"),o.hide(),o.trigger("hidden")))}}async dispatchMessage(e){let t={};if(typeof e=="string")t=JSON.parse(e);else{let s=new DataView(e,0,1).getUint8(0),o=new DataView(e,1,s),a=[];for(let l=0;l<s;l++)a.push(String.fromCharCode(o.getUint8(l)));let r=a.join("");e=e.slice(s+1),t.custom={},t.custom[r]=e}let i=v.default.Event("shiny:message");i.message=t,(0,v.default)(document).trigger(i),!i.isDefaultPrevented()&&(this.$outputProgress.updateStateFromMessage(i.message),await this._sendMessagesToHandlers(i.message,Ni,Dr),this.$updateConditionals())}async _sendMessagesToHandlers(e,t,i){for(let s=0;s<i.length;s++){let o=i[s];se(e,o)&&await t[o].call(this,e[o])}}_updateProgress(){let e=this.$outputProgress.takeChanges();for(let[t,i]of e.entries())se(this.$bindings,t)&&this.$bindings[t].showProgress(i)}_init(){A("values",async r=>{this._updateProgress();for(let l in r)se(r,l)&&await this.receiveOutput(l,r[l])}),A("errors",r=>{for(let l in r)se(r,l)&&this.receiveError(l,r[l])}),A("inputMessages",async r=>{for(let l=0;l<r.length;l++){let u=(0,v.default)(".shiny-bound-input#"+E(r[l].id)),d=u.data("shiny-input-binding");if(u.length>0){u.attr("aria-live")||u.attr("aria-live","polite");let c=u[0],p=v.default.Event("shiny:updateinput");if(p.message=r[l].message,p.binding=d,(0,v.default)(c).trigger(p),!p.isDefaultPrevented())try{await d.receiveMessage(c,p.message)}catch(m){console.error("[shiny] Error in inputBinding.receiveMessage()",{error:m,binding:d,message:p.message})}}}}),A("javascript",r=>{Qe(r)}),A("console",r=>{for(let l=0;l<r.length;l++)console.log&&console.log(r[l])}),A("progress",async r=>{if(r.type&&r.message){let l=await this.progressHandlers[r.type];l&&l.call(this,r.message)}}),A("notification",async r=>{if(r.type==="show")await Ee(r.message);else if(r.type==="remove")Se(r.message);else throw"Unkown notification type: "+r.type}),A("modal",async r=>{if(r.type==="show")await Hn(r.message);else if(r.type==="remove")Dn();else throw"Unkown modal type: "+r.type}),A("response",r=>{let l=r.tag,u=this.$activeRequests[l];u&&(delete this.$activeRequests[l],"value"in r?u.onSuccess(r.value):u.onError(r.error))}),A("allowReconnect",r=>{switch(r){case!0:case!1:case"force":this.$allowReconnect=r;break;default:throw"Invalid value for allowReconnect: "+r}}),A("custom",async r=>{let l=ds();l&&await l(r),await this._sendMessagesToHandlers(r,An,Rn)}),A("config",r=>{this.config={workerId:r.workerId,sessionId:r.sessionId},r.user&&os(r.user),(0,v.default)(document).trigger("shiny:sessioninitialized")}),A("busy",r=>{r==="busy"?((0,v.default)(document.documentElement).addClass("shiny-busy"),(0,v.default)(document).trigger("shiny:busy")):r==="idle"&&((0,v.default)(document.documentElement).removeClass("shiny-busy"),(0,v.default)(document).trigger("shiny:idle"))}),A("recalculating",r=>{if(se(r,"name")&&se(r,"status")){let l=this.$bindings[r.name];l?(0,v.default)(l.el).trigger("shiny:"+r.status):(0,v.default)().trigger("shiny:"+r.status)}}),A("reload",r=>{window.location.reload()}),A("shiny-insert-ui",async r=>{let l=(0,v.default)(r.selector);if(l.length===0)console.warn('The selector you chose ("'+r.selector+'") could not be found in the DOM.'),await mt(r.content.html,(0,v.default)([]),r.content.deps);else for(let u of l)if(await re(u,r.content,r.where),r.multiple===!1)break}),A("shiny-remove-ui",r=>{(0,v.default)(r.selector).each(function(u,d){return G(d,!0),(0,v.default)(d).remove(),r.multiple===!1?!1:void 0})}),A("frozen",r=>{for(let l=0;l<r.ids.length;l++)as(r.ids[l])});function e(r){let l=(0,v.default)("#"+E(r));if(l.length===0)throw"There is no tabsetPanel (or navbarPage or navlistPanel) with id equal to '"+r+"'";return l}function t(r){let l=r.attr("data-tabsetid");return(0,v.default)("div.tab-content[data-tabsetid='"+E(l)+"']")}function i(r,l,u){let d="[data-value='"+E(u)+"']",c=r.find("a"+d),p=c.parent();if(p.length===0)throw"There is no tabPanel (or navbarMenu) with value (or menuName) equal to '"+u+"'";let m=[],y=[];if(c.attr("data-toggle")==="dropdown"){let $=c.find("+ ul.dropdown-menu"),C=$.attr("data-tabsetid");$.find("a[data-toggle='tab']").parent("li").each(function(b,T){m.push((0,v.default)(T))});let L="div.tab-pane[id^='tab-"+E(C)+"']";l.find(L).each(function(b,T){y.push((0,v.default)(T))})}else y.push(l.find("div"+d));return{$liTag:p,$liTags:m,$divTags:y}}A("shiny-insert-tab",async r=>{let l=e(r.inputId),u=l,d=t(u),c=l.attr("data-tabsetid"),p=(0,v.default)("<div>");await re(p,r.liTag,"afterBegin");let m=(0,v.default)(p).find("> li"),y=m.find("> a"),$=null;r.target!==null&&($=i(u,d,r.target).$liTag);let C=K();if(C!==null){if(y.attr("data-toggle")==="dropdown")throw"Cannot insert a navbarMenu inside another one";u=C.$tabset,c=C.id,m.removeClass("nav-item").find(".nav-link").removeClass("nav-link").addClass("dropdown-item")}let I="";if(y.attr("data-toggle")==="tab"){let b=L(u,c),T="tab-"+c+"-"+b;m.find("> a").attr("href","#"+T),I=T}r.position==="before"?$?$.before(m):u.prepend(m):r.position==="after"&&($?$.after(m):u.append(m)),await ze($?.parent()||u),await re(d[0],r.divTag,"beforeEnd"),I&&d.find('[id="tab-tsid-id"]').attr("id",I),r.select&&m.find("a").tab("show");function L(b,T){let _=[0];return b.find("> li").each(function(){let Me=(0,v.default)(this).find("> a[data-toggle='tab']");if(Me.length>0){let et=Me.attr("href").replace(/.*(?=#[^\s]+$)/,"").replace("#tab-"+T+"-","");_.push(Number(et))}}),Math.max.apply(null,_)+1}function K(){if(r.menuName!==null){let b=(0,v.default)("a.dropdown-toggle[data-value='"+E(r.menuName)+"']");if(b.length===0)throw"There is no navbarMenu with menuName equal to '"+r.menuName+"'";let T=b.find("+ ul.dropdown-menu"),_=T.attr("data-tabsetid");return{$tabset:T,id:_}}else if(r.target!==null&&$!==null){let b=$.parent("ul");if(b.hasClass("dropdown-menu")){let T=b.attr("data-tabsetid");return{$tabset:b,id:T}}}return null}});function s(r){let l=r.data("shiny-input-binding");if(!l.getValue(r)){let u=o(r),d=v.default.Event("shiny:updateinput");d.binding=l,r.trigger(d),l.setValue(r[0],u)}}function o(r){return r.find("li:visible a[data-toggle='tab']").first().attr("data-value")||null}function a(r,l,u=!1){v.default.each(r,function(d,c){d==="$liTag"?l(c):d==="$divTags"?v.default.each(c,function(p,m){l(m)}):u&&d==="$liTags"&&v.default.each(c,function(p,m){l(m)})})}A("shiny-remove-tab",r=>{let l=e(r.inputId),u=t(l),d=i(l,u,r.target);a(d,c),s(l);function c(p){G(p,!0),p.remove()}}),A("shiny-change-tab-visibility",r=>{let l=e(r.inputId),u=t(l),d=i(l,u,r.target);a(d,c,!0),s(l);function c(p){r.type==="show"?p.css("display",""):r.type==="hide"&&(p.hide(),p.removeClass("active"))}}),A("updateQueryString",r=>{if(r.mode==="replace"){window.history.replaceState(null,null,r.queryString);return}let l=null;if(r.queryString.charAt(0)==="#")l="hash";else if(r.queryString.charAt(0)==="?")l="query";else throw"The 'query' string must start with either '?' (to update the query string) or with '#' (to update the hash).";let u=window.location.pathname,d=window.location.search,c=window.location.hash,p=u;l==="query"?p+=r.queryString:p+=d+r.queryString,window.history.pushState(null,null,p),r.queryString.indexOf("#")!==-1&&(l="hash"),window.location.hash!==c&&(l="hash"),l==="hash"&&(0,v.default)(document).trigger("hashchange")}),A("resetBrush",r=>{Cn(r.brushId)})}getTestSnapshotBaseUrl({fullUrl:e=!0}={}){let t=window.location,i="";return e&&(i=t.origin+t.pathname.replace(/\/[^/]*$/,"")),i+="/session/"+encodeURIComponent(this.config.sessionId)+"/dataobj/shinytest?w="+encodeURIComponent(this.config.workerId)+"&nonce="+Xt(),i}};var zn=class{constructor(){this.version="1.11.1.9000";let{inputBindings:e,fileInputBinding:t}=qs(),{outputBindings:i}=tr();ms(t),this.$escape=E,this.compareVersion=Hs,this.inputBindings=e,this.InputBinding=P,this.outputBindings=i,this.OutputBinding=U,this.resetBrush=Cn,this.notifications={show:Ee,remove:Se},this.modal={show:Hn,remove:Dn},this.addCustomMessageHandler=Pr,this.showReconnectDialog=Pn,this.hideReconnectDialog=Bn,this.renderDependenciesAsync=Ve,this.renderDependencies=Kn,this.renderContentAsync=re,this.renderContent=we,this.renderHtmlAsync=mt,this.renderHtml=Gn,this.initializedPromise=xr(),(0,H.default)(()=>{setTimeout(async()=>{try{await this.initialize()}catch(s){throw $n(s),s}},1)})}inDevMode(){return Wt()}async initialize(){rs(this),this.shinyapp=new On;let e=this.shinyapp;this.progressHandlers=e.progressHandlers;let t=new Ht(e),i=new Bt(t),s=new Pt(i),o=new Lt(s),a=new Dt(s),r;document.querySelector(".shiny-submit-button")?(r=a,document.querySelectorAll(".shiny-submit-button").forEach(function(f){f.addEventListener("click",function(h){h.preventDefault(),a.submit()})})):r=o;let l=new _t(r);this.setInputValue=this.onInputChange=function(f,h,B={}){let V=Ai(B);l.setInput(f,h,V)},this.forgetLastInputValue=function(f){i.forget(f)};let u=this.inputBindings,d=this.outputBindings,c=()=>({inputs:l,inputsRate:o,sendOutputHiddenState:Ze,maybeAddThemeObserver:I,inputBindings:u,outputBindings:d,initDeferredIframes:Br,outputIsRecalculating:f=>this.shinyapp?.$outputProgress.isRecalculating(f)??!1});this.bindAll=async function(f){await Sr(c(),f)},this.unbindAll=function(f,h=!1){Er(c(),f,h)};function p(f=document.documentElement){let h=u.getBindings();for(let B=0;B<h.length;B++){let V=h[B].binding,Z=V.find(f);if(Z)for(let le=0;le<Z.length;le++){let pe=(0,H.default)(Z[le]);pe.data("_shiny_initialized")||(pe.data("_shiny_initialized",!0),V.initialize(Z[le]))}}}this.initializeInputs=p;function m(f){let B=(0,H.default)(f).data("shiny-output-binding");return B?B.getId():null}p(document.documentElement);let y=ce(await Oi(c(),document.documentElement),f=>f.value);(0,H.default)(".shiny-image-output, .shiny-plot-output, .shiny-report-size").each(function(){let f=m(this),h=ii(this);(h.width!==0||h.height!==0)&&(y[".clientdata_output_"+f+"_width"]=h.width,y[".clientdata_output_"+f+"_height"]=h.height)});function $(f){if(!f)return null;let h=fe(f,"background-color");if(!h)return h;let B=h.match(/^rgba\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)\s*\)$/);if(h==="transparent"||B&&parseFloat(B[4])===0){let V=fe(f,"background-image");return V&&V!=="none"?null:$(f.parentElement)}return h}function C(f){let h=fe(f,"font-family"),B=fe(f,"font-size");return{families:h?.replace(/"/g,"").split(", "),size:B}}(0,H.default)(".shiny-image-output, .shiny-plot-output, .shiny-report-theme").each(function(){let f=this,h=m(f);y[".clientdata_output_"+h+"_bg"]=$(f),y[".clientdata_output_"+h+"_fg"]=fe(f,"color"),y[".clientdata_output_"+h+"_accent"]=ht(f),y[".clientdata_output_"+h+"_font"]=C(f),I(f)});function I(f){if(!window.MutationObserver)return;let h=f.classList;if(!(h.contains("shiny-image-output")||h.contains("shiny-plot-output")||h.contains("shiny-report-theme")))return;let V=(0,H.default)(f);if(V.data("shiny-theme-observer"))return;let Z=new ee(null,()=>L(f),100),le=new MutationObserver(()=>Z.normalCall()),pe={attributes:!0,attributeFilter:["style","class"]};le.observe(f,pe),V.data("shiny-theme-observer",le)}function L(f){if(f.classList.contains("shiny-output-error"))return;let h=m(f);l.setInput(".clientdata_output_"+h+"_bg",$(f)),l.setInput(".clientdata_output_"+h+"_fg",fe(f,"color")),l.setInput(".clientdata_output_"+h+"_accent",ht(f)),l.setInput(".clientdata_output_"+h+"_font",C(f))}function K(){(0,H.default)(".shiny-image-output, .shiny-plot-output, .shiny-report-size").each(function(){let f=m(this),h=ii(this);(h.width!==0||h.height!==0)&&(l.setInput(".clientdata_output_"+f+"_width",h.width),l.setInput(".clientdata_output_"+f+"_height",h.height))}),(0,H.default)(".shiny-image-output, .shiny-plot-output, .shiny-report-theme").each(function(){L(this)}),(0,H.default)(".shiny-bound-output").each(function(){let f=(0,H.default)(this),h=f.data("shiny-output-binding");f.trigger({type:"shiny:visualchange",visible:!b(this),binding:h}),h.onResize()})}ue.setImageSend(t,K);function b(f){return f===null||f.offsetWidth!==0||f.offsetHeight!==0?!1:fe(f,"display")==="none"?!0:b(f.parentNode)}let T={};(0,H.default)(".shiny-bound-output").each(function(){let f=m(this);b(this)?y[".clientdata_output_"+f+"_hidden"]=!0:(T[f]=!0,y[".clientdata_output_"+f+"_hidden"]=!1)});function _(){let f={};(0,H.default)(".shiny-bound-output").each(function(){let h=m(this);delete T[h];let B=b(this),V={type:"shiny:visualchange",visible:!B};B?l.setInput(".clientdata_output_"+h+"_hidden",!0):(f[h]=!0,l.setInput(".clientdata_output_"+h+"_hidden",!1));let Z=(0,H.default)(this);V.binding=Z.data("shiny-output-binding"),Z.trigger(V)});for(let h in T)x(T,h)&&l.setInput(".clientdata_output_"+h+"_hidden",!0);T=f}let Me=new ee(null,_,0);function Ze(){Me.normalCall()}t.lastChanceCallback.push(function(){Me.isPending()&&Me.immediateCall()});function et(f,h,...B){let V=f.split(".");return function(Z){let le=Z.namespace?.split(".")??[];for(let pe=0;pe<V.length;pe++)if(le.indexOf(V[pe])===-1)return;h.apply(this,[V,h,...B])}}(0,H.default)(window).resize($e(500,ue.regular));let Un=["modal","dropdown","tab","tooltip","popover","collapse"];H.default.each(Un,function(f,h){(0,H.default)(document.body).on("shown.bs."+h+".sendImageSize","*",et("bs",ue.regular)),(0,H.default)(document.body).on("shown.bs."+h+".sendOutputHiddenState hidden.bs."+h+".sendOutputHiddenState","*",et("bs",Ze))}),(0,H.default)(document.body).on("shown.sendImageSize","*",ue.regular),(0,H.default)(document.body).on("shown.sendOutputHiddenState hidden.sendOutputHiddenState","*",Ze),y[".clientdata_pixelratio"]=ni(),(0,H.default)(window).resize(function(){l.setInput(".clientdata_pixelratio",ni())}),y[".clientdata_url_protocol"]=window.location.protocol,y[".clientdata_url_hostname"]=window.location.hostname,y[".clientdata_url_port"]=window.location.port,y[".clientdata_url_pathname"]=window.location.pathname,y[".clientdata_url_search"]=window.location.search,(0,H.default)(window).on("pushstate",function(f){l.setInput(".clientdata_url_search",window.location.search)}),(0,H.default)(window).on("popstate",function(f){l.setInput(".clientdata_url_search",window.location.search)}),y[".clientdata_url_hash_initial"]=window.location.hash,y[".clientdata_url_hash"]=window.location.hash,(0,H.default)(window).on("hashchange",function(f){l.setInput(".clientdata_url_hash",window.location.hash)});let Jn=y[".clientdata_singletons"]=(0,H.default)('script[type="application/shiny-singletons"]').text();hs(Jn.split(/,/));let Qn=(0,H.default)('script[type="application/html-dependencies"]').text();H.default.each(Qn.split(/;/),function(f,h){let B=/\s*^(.+)\[(.+)\]\s*$/.exec(h);B&&qt(B[1],B[2])}),i.reset(y),e.connect(y),(0,H.default)(document).one("shiny:connected",()=>{Br()}),(0,H.default)(document).one("shiny:sessioninitialized",()=>{this.initializedPromise.resolve()})}};function Br(){!window.Shiny||!window.Shiny.shinyapp||!window.Shiny.shinyapp.isConnected()||(0,H.default)(".shiny-frame-deferred").each(function(n,e){let t=(0,H.default)(e);t.removeClass("shiny-frame-deferred"),t.attr("src",t.attr("data-deferred-src")),t.attr("data-deferred-src",null)})}function Lr(){return window.navigator.userAgent}var Nn=M(S());function Vn(){return Oe().config}function _r(){(0,Nn.default)(document).on("keydown",function(n){if(n.which!==114||!n.ctrlKey&&!n.metaKey||n.shiftKey||n.altKey)return;let e="reactlog?w="+window.escape(Vn().workerId)+"&s="+window.escape(Vn().sessionId);window.open(e),n.preventDefault()}),(0,Nn.default)(document).on("keydown",function(n){if(!(n.which===115&&(n.ctrlKey||n.metaKey)&&!n.shiftKey&&!n.altKey||n.which===114&&(n.ctrlKey||n.metaKey)&&n.shiftKey&&!n.altKey))return;let e="reactlog/mark?w="+window.escape(Vn().workerId)+"&s="+window.escape(Vn().sessionId);Nn.default.get(e,function(t){if(t!=="marked")return;Ee({html:'<span id="shiny-reactlog-mark-text">Marked time point in reactlog</span>',closeButton:!0})}).fail(function(){window.open(e)}),n.preventDefault()})}var Rr;function Ar(){if(window.Shiny)throw new Error("Trying to create window.Shiny, but it already exists!");Rr=window.Shiny=new zn,Zi(Lr()),es(),ss(),ns(),_r()}Ar();})();
