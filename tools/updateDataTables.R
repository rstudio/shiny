...
# version <- "1.10.21"
ref <- version
destdir <- rprojroot::find_package_root_file("inst", "www", "shared", "datatables")

stop("Not implemented")

# # There are a lot of files in the newer version.
# download.file(
...
#   {
#     exit_code <- system(paste0("yarn add --dev datatables.net@", version))
#     if (exit_code != 0) stop("yarn could not install datatables.net")
#   }
# )
