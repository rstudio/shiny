...
* Fixed [#2204](https://github.com/rstudio/shiny/issues/2204): `updateDateInput` could set the wrong date on days where DST begins. [#2212](https://github.com/rstudio/shiny/pull/2212)
