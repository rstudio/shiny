...
${r}`,m=new En({headline:c,message:p});((xr(s)?s.get(0):s)||window).dispatchEvent(m)}function t(s,o){let a=n.get(s);a?a.push(o):n.set(s,[o])}function i(s,o){let a=n.get(s);if(a){let r=a.indexOf(o);r>-1&&a.splice(r,1)}a?.length===0&&n.delete(s)}return{addBinding:t,removeBinding:i,checkValidity:e}})();function Ir(n,e){return n===0?"":n===1?`${n} ${e}`:`${n} ${e}s`}function Ho(n,e=document.documentElement){let{inputs:t,inputsRate:i,inputBindings:s}=n,o=s.getBindings(),a={};for(let r=0;r<o.length;r++){let l=o[r].binding,u=l.find(e)||[];for(let d=0;d<u.length;d++){let c=u[d];if(c.hasAttribute("data-shiny-no-bind-input"))continue;let p=l.getId(c);if(!p||(0,J.default)(c).hasClass("shiny-bound-input"))continue;let m=l.getType(c),y=m?p+":"+m:p;a[y]={value:l.getValue(c),opts:{immediate:!0,binding:l,el:c}};let $=function(){let I=l,B=c;return function(K){Co(t,I,B,K)}}();l.subscribe(c,$),(0,J.default)(c).data("shiny-input-binding",l),(0,J.default)(c).addClass("shiny-bound-input");let C=l.getRatePolicy(c);C!==null&&i.setRatePolicy(y,C.policy,C.delay),_t.addBinding(p,"input"),(0,J.default)(c).trigger({type:"shiny:bound",binding:l,bindingType:"input"})}}return a}async function Do({sendOutputHiddenState:n,maybeAddThemeObserver:e,outputBindings:t,outputIsRecalculating:i},s=document.documentElement){let o=(0,J.default)(s),a=t.getBindings();for(let r=0;r<a.length;r++){let l=a[r].binding,u=l.find(o)||[];for(let d=0;d<u.length;d++){let c=u[d],p=l.getId(c);if(!p||!J.default.contains(document.documentElement,c))continue;let m=(0,J.default)(c);if(m.hasClass("shiny-bound-output"))continue;e(c);let y=new Cn(c,l);await as(p,y),m.data("shiny-output-binding",y),m.addClass("shiny-bound-output"),m.attr("aria-live")||m.attr("aria-live","polite"),i(p)&&y.showProgress(!0),_t.addBinding(p,"output"),m.trigger({type:"shiny:bound",binding:l,bindingType:"output"})}}setTimeout(ue.regular,0),setTimeout(n,0)}function Po(n=document.documentElement,e=!1){let t=(0,J.default)(n).find(".shiny-bound-input").toArray();e&&(0,J.default)(n).hasClass("shiny-bound-input")&&t.push(n);for(let i=0;i<t.length;i++){let s=t[i],o=(0,J.default)(s).data("shiny-input-binding");if(!o)continue;let a=o.getId(s);(0,J.default)(s).removeClass("shiny-bound-input"),_t.removeBinding(a,"input"),o.unsubscribe(s),(0,J.default)(s).trigger({type:"shiny:unbound",binding:o,bindingType:"input"})}}function Lo({sendOutputHiddenState:n},e=document.documentElement,t=!1){let i=(0,J.default)(e).find(".shiny-bound-output").toArray();t&&(0,J.default)(e).hasClass("shiny-bound-output")&&i.push(e);for(let s=0;s<i.length;s++){let o=(0,J.default)(i[s]),a=o.data("shiny-output-binding");if(!a)continue;let r=a.binding.getId(i[s]);ls(r,a),_t.removeBinding(r,"output"),o.removeClass("shiny-bound-output"),o.removeData("shiny-output-binding"),o.trigger({type:"shiny:unbound",binding:a.binding,bindingType:"output"})}setTimeout(ue.regular,0),setTimeout(n,0)}async function Ri(n,e){await Do(n,e);let t=Ho(n,e);return _t.checkValidity(e),t}function Tr(n,e,t=!1){Po(e,t),Lo(n,e,t)}async function Er(n,e){let t=await Ri(n,e),i=n.inputs;J.default.each(t,function(s,o){i.setInput(s,o.value,o.opts)}),n.initDeferredIframes()}var Ae=M(S());async function kn({html:n="",deps:e=[]}={}){await Ne(e),(0,Ae.default)(".modal-backdrop").remove();let t=(0,Ae.default)("#shiny-modal-wrapper");t.length===0&&(t=(0,Ae.default)('<div id="shiny-modal-wrapper"></div>'),(0,Ae.default)(document.body).append(t),t.on("hidden.bs.modal",function(i){i.target===(0,Ae.default)("#shiny-modal")[0]&&(G(t),t.remove())})),t.on("keydown.shinymodal",function(i){(0,Ae.default)("#shiny-modal").data("keyboard")!==!1&&i.keyCode===27&&(i.stopPropagation(),i.preventDefault())}),await re(t,{html:n})}function Hn(){let n=(0,Ae.default)("#shiny-modal-wrapper");n.off("keydown.shinymodal");let e=n.find(".modal");e.length>0?(e.on("shown.bs.modal",()=>e.modal("hide")),e.modal("hide")):(G(n),n.remove())}var At=M(S());var Bo=250;async function Ee({html:n="",action:e="",deps:t=[],duration:i=5e3,id:s=null,closeButton:o=!0,type:a=null}={}){s||(s=qt()),await Ne(t),Ao();let r=Rt(s);r?.length===0&&(r=Ro(s));let l=r,u=`<div class="shiny-notification-content-text">${n}</div><div class="shiny-notification-content-action">${e}</div>`,d=l.find(".shiny-notification-content");await re(d,{html:u});let c=l?.attr("class");if(c){let m=c.split(/\s+/).filter(y=>y.match(/^shiny-notification-/)).join(" ");l.removeClass(m)}a&&a!=="default"&&l.addClass("shiny-notification-"+a);let p=l.find(".shiny-notification-close");return o&&p.length===0?l.append('<div class="shiny-notification-close">&times;</div>'):!o&&p.length!==0&&p.remove(),i?Oo(s,i):Sr(s),s}function Se(n){Rt(n)?.fadeOut(Bo,function(){G(this),(0,At.default)(this).remove(),_o().length===0&&Ot().remove()})}function Rt(n){return n?Ot().find("#shiny-notification-"+E(n)):null}function _o(){return Ot().find(".shiny-notification").map(function(){return this.id.replace(/shiny-notification-/,"")}).get()}function Ot(){return(0,At.default)("#shiny-notification-panel")}function Ao(){let n=Ot();return n.length>0||(0,At.default)(document.body).append('<div id="shiny-notification-panel">'),n}function Ro(n){let e=Rt(n);return e?.length===0&&(e=(0,At.default)(`<div id="shiny-notification-${n}" class="shiny-notification"><div class="shiny-notification-close">&times;</div><div class="shiny-notification-content"></div></div>`),e.find(".shiny-notification-close").on("click",t=>{t.preventDefault(),t.stopPropagation(),Se(n)}),Ot().append(e)),e}function Oo(n,e){Sr(n);let t=setTimeout(function(){Se(n)},e);Rt(n)?.data("removalCallback",t)}function Sr(n){let t=Rt(n)?.data("removalCallback");t&&clearTimeout(t)}var Oi=M(S());function Mr(n){let e=(0,Oi.default)("#shiny-reconnect-time");if(e.length===0)return;let t=Math.floor((n-new Date().getTime())/1e3);t>0?e.text(" in "+t+"s"):e.text("..."),setTimeout(function(){Mr(n)},1e3)}async function Dn(n){let e=new Date().getTime()+n;if((0,Oi.default)("#shiny-reconnect-text").length>0)return;await Ee({id:"reconnect",html:'<span id="shiny-reconnect-text">Attempting to reconnect</span><span id="shiny-reconnect-time"></span>',action:'<a id="shiny-reconnect-now" href="#" onclick="Shiny.shinyapp.reconnect();">Try now</a>',duration:null,closeButton:!1,type:"warning"}),Mr(e)}function Pn(){Se("reconnect")}var v=M(S());var Ln=class{constructor(){this.$promises=[];this.$resolvers=[]}_add(){let e=new Promise(t=>{this.$resolvers.push(t)});this.$promises.push(e)}enqueue(e){this.$resolvers.length||this._add(),this.$resolvers.shift()(e)}async dequeue(){return this.$promises.length||this._add(),this.$promises.shift()}isEmpty(){return!this.$promises.length}isBlocked(){return!!this.$resolvers.length}get length(){return this.$promises.length-this.$resolvers.length}};var A,$r,Cr,kr,Vi,Vt,Ye,Bn=class{constructor(){Qt(this,A);this.outputStates=new Map;this.changedOutputs=new Map}takeChanges(){let e=this.changedOutputs;return this.changedOutputs=new Map,e}isRecalculating(e){let t=F(this,A,Vt).call(this,e);return["initial","running","idle","persistent","invalidated"].includes(t)}updateStateFromMessage(e){Vo(e)&&F(this,A,$r).call(this,e),zo(e)&&F(this,A,Cr).call(this,e),No(e)&&F(this,A,kr).call(this,e)}};A=new WeakSet,$r=function(e){let{name:t,status:i}=e.recalculating,s=F(this,A,Vt).call(this,t);if(i==="recalculating")switch(s){case"initial":case"invalidated":F(this,A,Ye).call(this,t,"running");break;default:throw new Error(`Shiny server sent a message that the output '${t}' is recalculating,
            ...
            the output '${t}' has an unexpected ending state of: '${i}'.`)}},kr=function(e){let{id:t,persistent:i}=e.progress.message,s=F(this,A,Vt).call(this,t);if(i)switch(s){case"running":F(this,A,Ye).call(this,t,"persistent");break;default:throw new Error(`Shiny server has sent a 'persistent progress' message for ${t},
