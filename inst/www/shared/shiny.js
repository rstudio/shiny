...
(function() {
  ...
  function initShiny() {
    ...
    // Need to initialize datepickers before inputs are bound. This is so that
    // getValue() will work properly. Initialization makes it so the date picker
    // creates an internal Date representation of the value string, and
    // getValue() uses this.
