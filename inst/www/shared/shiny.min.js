...
${r}`,m=new Sn({headline:c,message:p});((Ir(s)?s.get(0):s)||window).dispatchEvent(m)}function t(s,o){let a=n.get(s);a?a.push(o):n.set(s,[o])}function i(s,o){let a=n.get(s);if(a){let r=a.indexOf(o);r>-1&&a.splice(r,1)}a?.length===0&&n.delete(s)}return{addBinding:t,removeBinding:i,checkValidity:e}})();function Tr(n,e){return n===0?"":n===1?`${n} ${e}`:`${n} ${e}s`}function Do(n,e=document.documentElement){let{inputs:t,inputsRate:i,inputBindings:s}=n,o=s.getBindings(),a={};for(let r=0;r<o.length;r++){let l=o[r].binding,u=l.find(e)||[];for(let d=0;d<u.length;d++){let c=u[d];if(c.hasAttribute("data-shiny-no-bind-input"))continue;let p=l.getId(c);if(!p||(0,Q.default)(c).hasClass("shiny-bound-input"))continue;let m=l.getType(c),y=m?p+":"+m:p;a[y]={value:l.getValue(c),opts:{immediate:!0,binding:l,el:c}};let $=function(){let I=l,L=c;return function(K){ko(t,I,L,K)}}();l.subscribe(c,$),(0,Q.default)(c).data("shiny-input-binding",l),(0,Q.default)(c).addClass("shiny-bound-input");let C=l.getRatePolicy(c);C!==null&&i.setRatePolicy(y,C.policy,C.delay),At.addBinding(p,"input"),(0,Q.default)(c).trigger({type:"shiny:bound",binding:l,bindingType:"input"})}}return a}async function Po({sendOutputHiddenState:n,maybeAddThemeObserver:e,outputBindings:t,outputIsRecalculating:i},s=document.documentElement){let o=(0,Q.default)(s),a=t.getBindings();for(let r=0;r<a.length;r++){let l=a[r].binding,u=l.find(o)||[];for(let d=0;d<u.length;d++){let c=u[d],p=l.getId(c);if(!p||!Q.default.contains(document.documentElement,c))continue;let m=(0,Q.default)(c);if(m.hasClass("shiny-bound-output"))continue;e(c);let y=new kn(c,l);await ls(p,y),m.data("shiny-output-binding",y),m.addClass("shiny-bound-output"),m.attr("aria-live")||m.attr("aria-live","polite"),i(p)&&y.showProgress(!0),At.addBinding(p,"output"),m.trigger({type:"shiny:bound",binding:l,bindingType:"output"})}}setTimeout(ue.regular,0),setTimeout(n,0)}function Bo(n=document.documentElement,e=!1){let t=(0,Q.default)(n).find(".shiny-bound-input").toArray();e&&(0,Q.default)(n).hasClass("shiny-bound-input")&&t.push(n);for(let i=0;i<t.length;i++){let s=t[i],o=(0,Q.default)(s).data("shiny-input-binding");if(!o)continue;let a=o.getId(s);(0,Q.default)(s).removeClass("shiny-bound-input"),At.removeBinding(a,"input"),o.unsubscribe(s),(0,Q.default)(s).trigger({type:"shiny:unbound",binding:o,bindingType:"input"})}}function Lo({sendOutputHiddenState:n},e=document.documentElement,t=!1){let i=(0,Q.default)(e).find(".shiny-bound-output").toArray();t&&(0,Q.default)(e).hasClass("shiny-bound-output")&&i.push(e);for(let s=0;s<i.length;s++){let o=(0,Q.default)(i[s]),a=o.data("shiny-output-binding");if(!a)continue;let r=a.binding.getId(i[s]);us(r,a),At.removeBinding(r,"output"),o.removeClass("shiny-bound-output"),o.removeData("shiny-output-binding"),o.trigger({type:"shiny:unbound",binding:a.binding,bindingType:"output"})}setTimeout(ue.regular,0),setTimeout(n,0)}async function Oi(n,e){await Po(n,e);let t=Do(n,e);return At.checkValidity(e),t}function Er(n,e,t=!1){Bo(e,t),Lo(n,e,t)}async function Sr(n,e){let t=await Oi(n,e),i=n.inputs;Q.default.each(t,function(s,o){i.setInput(s,o.value,o.opts)}),n.initDeferredIframes()}var _e=M(S());async function Hn({html:n="",deps:e=[]}={}){await Ve(e),(0,_e.default)(".modal-backdrop").remove();let t=(0,_e.default)("#shiny-modal-wrapper");t.length===0&&(t=(0,_e.default)('<div id="shiny-modal-wrapper"></div>'),(0,_e.default)(document.body).append(t),t.on("hidden.bs.modal",function(i){i.target===(0,_e.default)("#shiny-modal")[0]&&(G(t),t.remove())})),t.on("keydown.shinymodal",function(i){(0,_e.default)("#shiny-modal").data("keyboard")!==!1&&i.keyCode===27&&(i.stopPropagation(),i.preventDefault())}),await re(t,{html:n})}function Dn(){let n=(0,_e.default)("#shiny-modal-wrapper");n.off("keydown.shinymodal");let e=n.find(".modal");e.length>0?(e.on("shown.bs.modal",()=>e.modal("hide")),e.modal("hide")):(G(n),n.remove())}var Rt=M(S());var _o=250;async function Ee({html:n="",action:e="",deps:t=[],duration:i=5e3,id:s=null,closeButton:o=!0,type:a=null}={}){s||(s=Xt()),await Ve(t),Ro();let r=Ot(s);r?.length===0&&(r=Oo(s));let l=r,u=`<div class="shiny-notification-content-text">${n}</div><div class="shiny-notification-content-action">${e}</div>`,d=l.find(".shiny-notification-content");await re(d,{html:u});let c=l?.attr("class");if(c){let m=c.split(/\s+/).filter(y=>y.match(/^shiny-notification-/)).join(" ");l.removeClass(m)}a&&a!=="default"&&l.addClass("shiny-notification-"+a);let p=l.find(".shiny-notification-close");return o&&p.length===0?l.append('<div class="shiny-notification-close">&times;</div>'):!o&&p.length!==0&&p.remove(),i?zo(s,i):Mr(s),s}function Se(n){Ot(n)?.fadeOut(_o,function(){G(this),(0,Rt.default)(this).remove(),Ao().length===0&&zt().remove()})}function Ot(n){return n?zt().find("#shiny-notification-"+E(n)):null}function Ao(){return zt().find(".shiny-notification").map(function(){return this.id.replace(/shiny-notification-/,"")}).get()}function zt(){return(0,Rt.default)("#shiny-notification-panel")}function Ro(){let n=zt();return n.length>0||(0,Rt.default)(document.body).append('<div id="shiny-notification-panel">'),n}function Oo(n){let e=Ot(n);return e?.length===0&&(e=(0,Rt.default)(`<div id="shiny-notification-${n}" class="shiny-notification"><div class="shiny-notification-close">&times;</div><div class="shiny-notification-content"></div></div>`),e.find(".shiny-notification-close").on("click",t=>{t.preventDefault(),t.stopPropagation(),Se(n)}),zt().append(e)),e}function zo(n,e){Mr(n);let t=setTimeout(function(){Se(n)},e);Ot(n)?.data("removalCallback",t)}function Mr(n){let t=Ot(n)?.data("removalCallback");t&&clearTimeout(t)}var zi=M(S());function $r(n){let e=(0,zi.default)("#shiny-reconnect-time");if(e.length===0)return;let t=Math.floor((n-new Date().getTime())/1e3);t>0?e.text(" in "+t+"s"):e.text("..."),setTimeout(function(){$r(n)},1e3)}async function Pn(n){let e=new Date().getTime()+n;if((0,zi.default)("#shiny-reconnect-text").length>0)return;await Ee({id:"reconnect",html:'<span id="shiny-reconnect-text">Attempting to reconnect</span><span id="shiny-reconnect-time"></span>',action:'<a id="shiny-reconnect-now" href="#" onclick="Shiny.shinyapp.reconnect();">Try now</a>',duration:null,closeButton:!1,type:"warning"}),$r(e)}function Bn(){Se("reconnect")}var v=M(S());var Ln=class{constructor(){this.$promises=[];this.$resolvers=[]}_add(){let e=new Promise(t=>{this.$resolvers.push(t)});this.$promises.push(e)}enqueue(e){this.$resolvers.length||this._add(),this.$resolvers.shift()(e)}async dequeue(){return this.$promises.length||this._add(),this.$promises.shift()}isEmpty(){return!this.$promises.length}isBlocked(){return!!this.$resolvers.length}get length(){return this.$promises.length-this.$resolvers.length}};var A,Cr,kr,Hr,Vi,Vt,Ye,_n=class{constructor(){Qt(this,A);this.outputStates=new Map;this.changedOutputs=new Map}takeChanges(){let e=this.changedOutputs;return this.changedOutputs=new Map,e}isRecalculating(e){let t=F(this,A,Vt).call(this,e);return["initial","running","idle","persistent","invalidated"].includes(t)}updateStateFromMessage(e){Vo(e)&&F(this,A,Cr).call(this,e),No(e)&&F(this,A,kr).call(this,e),Uo(e)&&F(this,A,Hr).call(this,e)}};A=new WeakSet,Cr=function(e){let{name:t,status:i}=e.recalculating,s=F(this,A,Vt).call(this,t);if(i==="recalculating")switch(s){case"initial":case"invalidated":F(this,A,Ye).call(this,t,"running");break;default:throw new Error(`Shiny server sent a message that the output '${t}' is recalculating,
            ...
            but the output is in an unexpected state of: '${s}'.`)}},kr=function(e){for(let t in e.values)F(this,A,Vi).call(this,t,"value");for(let t in e.errors)F(this,A,Vi).call(this,t,"error");for(let[t,i]of this.outputStates)switch(i){case"idle":F(this,A,Ye).call(this,t,"cancel");break;case"value":case"error":case"cancel":case"persistent":case"invalidated":break;default:throw new Error(`Shiny server sent a flush message, and after processing the values and errors,
            the output '${t}' has an unexpected ending state of: '${i}'.`)}},Hr=function(e){let{id:t,persistent:i}=e.progress.message,s=F(this,A,Vt).call(this,t);if(i)switch(s){case"running":F(this,A,Ye).call(this,t,"persistent");break;default:throw new Error(`Shiny server has sent a 'persistent progress' message for ${t},
