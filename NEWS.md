...
* Improved accessibility for `checkboxGroupInput()`: Similar to #3106, all checkboxes, made by `checkboxGroupInput()`, are grouped together semantically for assistive technologies. (thanks @jooyoungseo, #3110)
