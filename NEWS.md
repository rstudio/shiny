...
* Fixed [#2335](https://github.com/rstudio/shiny/issues/2335): `dateInput()` value is empty when max/min is equal to the current value. ([#2526](https://github.com/rstudio/shiny/pull/2526)) 
